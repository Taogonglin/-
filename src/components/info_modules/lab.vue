<template>
    ...
    <div class="center">
      <!--头部-->
      <login-head/>
       <el-page-header @back="goBack" content="实验室开放时间"></el-page-header>
        <!-- <div style="margin-top: 20px;display: flex;justify-content: center">
            <el-input v-model="keywords" placeholder="通过实验室名称搜索..." prefix-icon="el-icon-search"
            ...
            <el-card class="hr-card" v-for="(user,index) in users" :key="index">
                ...
                <div>
                    ...
                    <div class="userinfo-container">
                        <div>实验室编号：{{user.id}}</div>
                        
                        <div>实验室开放时间：{{user.openTime}}</div>
                        <div>实验室关闭时间：{{user.closeTime}}</div>
...
export default {
    ...
    methods: {
        ...
        initAlldata() {
            ...
            this.$axios.get('http://127.0.0.1:8080/lab/').then(res => {
